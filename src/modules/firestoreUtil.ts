...
import { getFirestore, Firestore, Transaction, QuerySnapshot, DocumentData, WhereFilterOp, FieldValue } from 'firebase-admin/firestore';
...
export class FirestoreTransaction{
  ...
  async getCollection(collectionPath: string,  orderByField?: string, fieldPath?:string, opStr?:WhereFilterOp, value?: unknown){
