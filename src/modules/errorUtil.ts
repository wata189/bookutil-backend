...
export const catchError = (err: Error, req: Request, res: Response): void => {
  systemLogger.error(err);
  if (!res.statusCode || res.statusCode < util.STATUS_CODES.BAD_REQUEST)
    res.status(util.STATUS_CODES.INTERNAL_SERVER_ERROR);
